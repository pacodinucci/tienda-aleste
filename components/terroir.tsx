...
const TerroirSection = () => {
  ...
  return (
    <div ref={ref} className="pt-28 px-6 relative">
      <motion.h1
      ...
      <motion.div
        className={`${montserrat.className} z-10 w-[50%] flex flex-col gap-y-4 absolute top-36 right-32 text-neutral-200 bg-cuero p-10`}
        initial={{ x: 100, opacity: 1 }}
        animate={isInView ? { x: 0, opacity: 1 } : {}}
        transition={{ duration: 0.8 }}
      >
